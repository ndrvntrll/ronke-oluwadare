...
if ( ! class_exists( 'Tracem_Navwalker' ) ) {
	/**
	 * Tracem_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Tracem_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$output .= "\n$indent<ul role=\"menu\" class=\" tracem-dropdown-menu\" >\n";
		}
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				echo '>';
				echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr__( 'Add a menu', 'tracem' ) . '">' . esc_html__( 'Add a menu', 'tracem' ) . '</a></li>';
				echo '</ul>';
				if ( $container ) {
					echo '</' . esc_attr( $container ) . '>'; }
			}
