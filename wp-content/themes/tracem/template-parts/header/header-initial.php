...
<div class="header-area tracem-initial tracem-primary-header tracem-initial-header <?php echo esc_attr( $is_trans ); ?> <?php echo esc_attr( $is_white ); ?>">
