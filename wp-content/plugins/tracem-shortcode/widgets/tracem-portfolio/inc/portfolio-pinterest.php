<section class="tracem-portfolio-area tracem-relative portfolio-pinterest is-animation <?php echo esc_attr( $settings['portfolio_hover_types'] ); ?>" id="tracem-portfolio">
