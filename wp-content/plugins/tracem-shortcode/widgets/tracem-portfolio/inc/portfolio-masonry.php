        ...
        <div class="grid portfolio-content" id="portfolio-container">
            ...
            if( function_exists( 'cs_get_option' ) ) {
                ...
                if ( $tracem_portfolio_masonary_dimension == 'large-width' || $tracem_portfolio_masonary_dimension == 'large-width-height' ) {
                    $grid_col = 'col-xs-12 col-sm-6 col-md-6 col-lg-6';
                } else {
                    $grid_col = 'col-xs-12 col-sm-6 col-md-6 col-lg-3';
                }
            }
            ?>
            <div class="grid-item <?php echo esc_attr( $grid_col ); ?>">
                <div class="grid-item-wrapper">
                    <div class="portfolio-img">
                        <?php
                        if( $settings['is_lightbox'] ) {
                            echo '<a class="mixed" href="' . esc_url( get_the_post_thumbnail_url( get_the_ID(), 'full' ) ) . '"><div class="lightbox-overlay"><span class="ti-plus"></span></div>';
                        }
                        ?>
                        <?php
