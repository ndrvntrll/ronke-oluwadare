...
<div class="piecharts-area piechart-02">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        if( $settings['piecharts'] ) { ?>
            <div class="row">
                ...
                ?>
                <div class="col-md col-sm-6 col-12 chart-wrapper-2">
                    <div class="chart-2 chart-number">
                        <div class="chart-2-<?php echo esc_attr( $i ); ?> chart-value" data-size="<?php echo esc_attr( $settings['size'] ); ?>" data-width="<?php echo esc_attr( $settings['width'] ); ?>" data-tcolor="<?php echo esc_attr( $settings['tcolor'] ) ?>" data-barcolor="<?php echo esc_attr( $settings['barcolor'] ) ?>" data-percent="<?php echo esc_attr( $number ); ?>"><span><?php echo esc_html( $number ); ?>%</span></div>
                        <?php
                        if( $text ) {
