...
class Tracem_Coming_Soon extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		include( $tracem_plugin_dir . '/coming-soon.php' );
	}
}