...
<div class="our-pricing-area pricing-two pricing-three">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        <div class="our-pricing">
            <div class="row">
                ...
                foreach( $settings['pricing'] as $single_pricing ) :
                    ...
                    ?>
                    <div class="col-md-4 col-sm-6 col-12 pricing-wrap">
                        <div class="single-pricing">
                            <?php
                            if( $package_name ) {
                                echo '<div class="package-name text-center"><h5>' . esc_html( $package_name ) . '</h5></div><!-- .package-name -->';
                            }
                            if( $price ) {
                                echo '<div class="package-price text-center"><h2><span>' . esc_html( $price_in ) . '</span>' . esc_html( $price ) . '</h2></div><!-- .package-price -->';
                            }
                            if( $price_des ) {
                    ...
                    </div><!-- .col-md-4 col-sm-6 col-12 pricing-wrap -->
                <?php endforeach; ?>
