...
<div class="progressbar-area progressbar-area-02">
    <div class="container">
        <div class="row">
            <div class="col-12">
        ...
        if( $settings['progressbars'] ) { ?>
            <div class="row">
                <div class="col-12">
                    ...
                    ?>
                    <div class="tracem-progress progressbar-02 tracem-progress-<?php echo esc_attr( $i ); ?>">
                        <div class="tracem-progress-bar-2-<?php echo esc_attr( $i ); ?> tracem-progress-bar" data-number="<?php echo esc_attr( $number ); ?>" data-barcolor="<?php echo esc_attr( $settings['barcolor'] ); ?>"></div><!-- .proress-bar -->
                        <?php
                        if( $text ) {
