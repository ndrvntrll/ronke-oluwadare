...
class Elementor_Post_Grid_Widget extends Widget_Base {
	...
	protected function render( $instance = [] ) {
		...
		?>
		<div class="wpcap-grid section-blog-posts-area">
			<?php
			...
			?>
			<div class="wpcap-grid-container container elementor-grid <?php echo $columns_desktop.$columns_tablet.$columns_mobile.$grid_class; ?>">
